...
const { dateTimeField: dateTimeInput , startBtn , daysField: daysInput , hoursField: hoursInput , minutesField: minutesInput , secondsField: secondsInput ,  } = refs;
timerStyle();
function timerStyle() {
...
const options = {
    ...
    onClose ([selectedDate]) {
        if (!selectedDate || selectedDate < options["defaultDate"]) {
            (0, _notiflixNotifyAio.Notify).failure("Please choose Date in the future!");
            return;
        }
...
(0, _flatpickrDefault.default)(dateTimeInput, options);
...
},{"flatpickr":"llQu5","flatpickr/dist/flatpickr.min.css":"eVN6V","notiflix/build/notiflix-notify-aio":"eXQLZ","flatpickr/dist/themes/light.css":"gTm5l","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"llQu5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"gTm5l":[function() {},{}]},["8lKsl","1AWyZ"], "1AWyZ", "parcelRequired7c6")
