...
function submitPromises(e) {
    ...
    for(let i = 1; i <= amount.valueAsNumber; i += 1){
        createPromise(i, delay1).then(({ position , delay  })=>{
            (0, _notiflixNotifyAio.Notify).success(`✅ Fulfilled promise ${i} in ${delay}ms`);
        }).catch(({ position , delay  })=>{
            (0, _notiflixNotifyAio.Notify).failure(`❌ Rejected promise ${i} in ${delay}ms`);
        }).finally(()=>form.reset());
        delay1 += step.valueAsNumber;
    }
...
},{"notiflix/build/notiflix-notify-aio":"eXQLZ","notiflix/dist/notiflix-3.2.5.min.css":"jvRD8"}],"eXQLZ":[function(require,module,exports) {
var global = arguments[3];
/*
...
},{}],"jvRD8":[function() {},{}]},["dDjGg","8tzFL"], "8tzFL", "parcelRequired7c6")
